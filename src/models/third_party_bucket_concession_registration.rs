...
impl ThirdPartyBucketConcessionRegistration {
    pub fn new(name: String, shareidentifier: String, credentialidentifierplaintext: String, credentialsecretplaintext: String) -> ThirdPartyBucketConcessionRegistration {
