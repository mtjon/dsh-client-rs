...
pub async fn allocation_tenant_volume_id_actual_get(configuration: &configuration::Configuration, tenant: &str, id: &str) -> Result<crate::models::Volume, Error<AllocationTenantVolumeIdActualGetError>> {
    let local_var_configuration = configuration;
...
pub async fn allocation_tenant_volume_id_configuration_get(configuration: &configuration::Configuration, tenant: &str, id: &str) -> Result<crate::models::Volume, Error<AllocationTenantVolumeIdConfigurationGetError>> {
    let local_var_configuration = configuration;
...
pub async fn allocation_tenant_volume_id_configuration_put(configuration: &configuration::Configuration, tenant: &str, id: &str, volume: crate::models::Volume) -> Result<(), Error<AllocationTenantVolumeIdConfigurationPutError>> {
    let local_var_configuration = configuration;
...
pub async fn allocation_tenant_volume_id_get(configuration: &configuration::Configuration, tenant: &str, id: &str) -> Result<crate::models::VolumeStatus, Error<AllocationTenantVolumeIdGetError>> {
    let local_var_configuration = configuration;
...
pub async fn allocation_tenant_volume_id_status_get(configuration: &configuration::Configuration, tenant: &str, id: &str) -> Result<crate::models::AllocationStatus, Error<AllocationTenantVolumeIdStatusGetError>> {
    let local_var_configuration = configuration;
